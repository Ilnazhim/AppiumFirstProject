...
class FormsPage(BaseClass):
    ...
    input_form_name = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.EditText"
    ...
    def get_input_form_name(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable((AppiumBy.XPATH, self.input_form_name)))
    ...
    def input_input_form_name(self, form_name):
        name = datetime.datetime.utcnow().strftime("%d.%m.%Y..%H:%M")
        self.get_input_form_name().send_keys(form_name + str(name))
        print("Input name")
    ...
    def fill_the_form_no_zhk(self):
        with allure.step("fill_the_form_no_zhk"):
            self.click_no_zhk()
            self.input_input_form_name("Автотест Нет моего ЖК ")
    ...
    def fill_the_form_do_app_better(self):
        with allure.step("fill_the_form_do_app_better"):
            self.input_input_form_name("Автотест Помогите нам улучшить приложение ")
